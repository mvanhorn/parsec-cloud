...
.. _Parsec CLI: https://github.com/Scille/parsec-cloud/releases/download/v3.8.2-a.0.dev.20564+5919946/parsec-cli_3.8.2-a.0.dev.20564+5919946_linux-x86_64-musl
...
2. Make the file executable
  ...
  - Or use the :command:`chmod` command:
    ...
    .. code-block:: shell
        ...
        chmod +x parsec-cli_3.8.2-a.0.dev.20564+5919946_linux-x86_64-musl

3. Verify the installation by running the following command:

  .. code-block:: shell

      ./parsec-cli_3.8.2-a.0.dev.20564+5919946_linux-x86_64-musl --version

  The Parsec CLI version should be displayed:

  .. code-block:: shell

      parsec-cli 3.8.2-a.0.dev.20564+5919946
